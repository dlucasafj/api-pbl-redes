...
class PacienteRepository {
  ...
  async updateValue(pacienteName, paciente) {
    ...
    currentFile.find(({ name }) => pacienteName === name).equipamento =
      paciente.equipamento;
    currentFile.find(({ name }) => pacienteName === name).sistolica =
      paciente.sistolica;
    currentFile.find(({ name }) => pacienteName === name).diastolica =
      paciente.diastolica;
    currentFile.find(({ name }) => pacienteName === name).temperatura =
